...
4. To setup your local db, run `python manage.py makemigrations` and `python manage.py migrate`
5. Run `python manage.py runserver` and view the site at the port
